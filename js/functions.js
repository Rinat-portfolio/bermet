...
function getMinutesLabel(minutes) {
  let minutes_label = "минут";
  if (minutes == 1) {
    minutes_label = "минута";
...
function getSecondsLabel(seconds) {
  let seconds_label = "секунд";
  if (seconds == 1) {
    seconds_label = "секунда";
...
function timeElapse(date) {
  ...
  let days_label = getDaysLabel(days);
  let hours_label = getHoursLabel(hours);
  let minutes_label = getMinutesLabel(minutes);
  let seconds_label = getSecondsLabel(seconds);
  var result =
    '<span class="digit">' +
    days +
    "</span> " +
    ...
    ' <span class="digit">' +
    hours +
    '</span> '+hours_label+' <span class="digit">' +
    minutes +
    '</span> '+minutes_label+' <span class="digit">' +
    seconds +
    "</span> "+seconds_label;
